---
name: skill-dedup
description: Use when the user asks to check skills for duplication, find skills that should be merged or split, or analyze a skill collection for unclear boundaries and trigger collisions. For single-skill definition quality, use skill-lint.
---
